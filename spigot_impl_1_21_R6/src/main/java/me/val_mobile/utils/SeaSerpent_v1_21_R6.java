...
public class SeaSerpent_v1_21_R6 extends ElderGuardian implements SeaSerpent {

    private final SeaSerpentVariant variant;
    
    public SeaSerpent_v1_21_R6(EntityType<? extends ElderGuardian> entitytype, Level world) {
    ...
    public SeaSerpent_v1_21_R6(Location loc) {
    ...
    public SeaSerpent_v1_21_R6(Location loc, SeaSerpentVariant variant) {
        super(EntityType.ELDER_GUARDIAN, ((CraftWorld) loc.getWorld()).getHandle());
        this.setPos(loc.getX(), loc.getY(), loc.getZ());
