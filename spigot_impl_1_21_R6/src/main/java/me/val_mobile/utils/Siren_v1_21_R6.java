...
public class Siren_v1_21_R6 extends Guardian implements Siren {

    public Siren_v1_21_R6(EntityType<? extends Guardian> entitytype, Level world) {
        super(entitytype, world);

        setup();
    }

    public Siren_v1_21_R6(Location loc) {
